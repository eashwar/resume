...
\begin{center}
	...
	{\color{darkgreen}{\faEnvelope\ \bodyfont{eashwar@umich.edu}}} | {\color{darkgreen}{\faMapMarker\ \bodyfont{Ann Arbor, MI}}} | {\color{darkgreen}{\faLink\ \bodyfont{eash.fyi}}}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     Education
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\vspace{-3mm}
	...
	{\begin{cvitems}
		...
		\item {See personal website for full list of presentations given at club}
	...
	{January 2018 – Present}
	{\begin{cvitems}
		\item {Developing the back-end for the Michigan Hackers website (michiganhackers.org) using Golang.}
