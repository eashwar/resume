...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
	\headerfirstnamestyle{Curriculum Vitae/Resume}
	\headerlastnamestyle{Eashwar Mohan}
	% \headerfirstnamestyle{Eashwar}  \headerlastnamestyle{Mohan} \\

	{\color{darkgreen}{\bodyfont{Resume}}} | {\color{darkgreen}{\bodyfont{UMID 31216382}}} | {\color{darkgreen}{\bodyfont{SUGS MSE CSE}}} | {\color{darkgreen}{\faEnvelope\ \bodyfont{eashwar@umich.edu}}} | {\color{darkgreen}{\faMapMarker\ \bodyfont{Ann Arbor, MI}}} | {\color{darkgreen}{\faLink\ \bodyfont{eash.dev}}}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     Education
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
