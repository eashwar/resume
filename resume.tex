...
\definecolor{awesome}{HTML}{604093}
%% Colors for text
...
\begin{center}
	...
	% {\color{purple}{\faEnvelope\ \bodyfont{eash@eash.dev}}} | {\color{purple}{\faMapMarker\ \bodyfont{San Francisco, CA}}} | {\color{purple}{\faLink\ \bodyfont{eash.dev}}}
\end{center}
